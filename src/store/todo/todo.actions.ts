...
export const todoAction = {
  fetchTasks: createAsyncAction(todoActionTypes.FETCH_TASKS)<void, void, Tasks>(),
  fetchTask: createAsyncAction(todoActionTypes.FETCH_TASK)<TaskId, void, Task>(),
  createTask: createAsyncAction(todoActionTypes.CREATE_TASK)<Task, void, Task>(),
  updateTask: createAsyncAction(todoActionTypes.UPDATE_TASK)<Task, void, Task>(),
  deleteTask: createAsyncAction(todoActionTypes.DELETE_TASK)<TaskId>(),
};
